...
class Playground extends MonoBehaviour {
	...
	static var version : String = "1.15.3";
	...
	static function ResourceInstantiate (n : String) : GameObject {
		var res : GameObject = UnityEngine.Resources.Load(n) as GameObject;
		if (!res)
			return null;
	...
	function InitializePlayground () {
		...
		for (i = 0; i<particleSystems.Count; i++) {
			...
			if (particleSystems[i].particleSystemGameObject.activeInHierarchy)
